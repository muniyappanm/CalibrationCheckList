...
public class ExampleItem {
    ...
    public ExampleItem() {
            Particular= new String[]{"WHETHER TT CALIBRATION AT IOC SALEM TERMINAL IS DUE?",
                    ...
                    "DEALER/TRANSPORTER SHALL BE FULLY RESPONSIBLE FOR DEGASSING OF TT BY OVERFLOWING WATER IN EACH " +
                            "COMPARTMENT BEFORE CARRYING OUT ANY HOT WORK IN THE TT","REMARKS IF ANY"};
